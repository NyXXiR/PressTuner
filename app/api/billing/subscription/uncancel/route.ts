// app/api/billing/subscription/uncancel/route.ts
import { NextResponse } from "next/server";
import { requireTeamContext, isAdmin } from "@/lib/auth";
import { apiError } from "@/lib/utils/api";
import { uncancelSubscriptionForTeam } from "@/lib/services/billing/subscriptionService";
...
export async function POST(req: Request) {
  try {
    ...
    const updated = await uncancelSubscriptionForTeam(team.id, product);
