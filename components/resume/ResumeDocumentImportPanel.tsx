      ...
      <label className="grid gap-1.5 text-xs font-bold text-muted-foreground">
        ...
        <select
          ...
          onChange={(event) => {
            ...
            const normalized = normalizeResumeItemDateValues({ ...payload, itemKind, ...(itemKind === "career-detail" ? { detailType: payload.detailType ?? "project" } : { detailType: undefined, detailLabel: undefined, relatedWorkItemId: undefined, relatedWorkTitle: undefined }) });
