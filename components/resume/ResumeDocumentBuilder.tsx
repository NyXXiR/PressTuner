...
import { ArrowDown, ArrowUp, Check, ChevronDown, ClipboardCheck, Copy, Edit3, Eye, EyeOff, FileText, FileUp, GripVertical, LayoutTemplate, MoreHorizontal, Plus, Printer, RotateCcw, Settings2, Sparkles, Trash2, X } from "lucide-react";
      ...
      <header className="resume-builder-chrome border-b-2 border-foreground pb-5">
        <div className="flex flex-col justify-between gap-5 xl:flex-row xl:items-end">
          ...
          <div className="resume-builder-actions flex flex-wrap gap-2">
            <button className="inline-flex h-11 items-center gap-2 border border-primary bg-background px-4 text-sm font-bold text-primary disabled:cursor-not-allowed disabled:opacity-50" disabled={!hydrated} onClick={() => openAiEdit()} type="button"><Sparkles className="h-4 w-4" /> 외부 AI로 이력서 다듬기</button>
