...
const isCareerTimelineSectionId = (sectionId: string) => sectionId === "experience" || sectionId === "projects" || sectionId === "careerDescriptions";
