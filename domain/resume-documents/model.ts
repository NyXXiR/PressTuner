  ...
  return {
    ...
    sharedSections: [
      ...
      { id: "experience", title: "경력", kind: "items", content: { sortDirection: "latest-first", items: [
        { id: "starter-work-current", itemKind: "work", meta: "2024.01 — 현재", title: "회사명", subtitle: "부서 · 직책", body: "재직 기간의 역할과 핵심 책임을 간결하게 적어주세요." },
        { id: "starter-work-previous", itemKind: "work", meta: "2022.01 — 2023.12", title: "이전 회사명", subtitle: "부서 · 직책", body: "이전 직장의 역할과 핵심 책임을 간결하게 적어주세요." },
      ] } },
      { id: "projects", title: "경력 상세", kind: "items", content: { sortDirection: "latest-first", items: [
        { id: "starter-career-detail", itemKind: "career-detail", detailType: "project", meta: "2024.01 — 현재", title: "프로젝트 또는 업무명", subtitle: "역할 · 사용 기술", body: "해결한 문제, 맡은 역할, 실행 내용과 결과를 적어주세요." },
      ] } },
      { id: "skills", title: "핵심 역량", kind: "tags", content: { items: ["문제 해결", "협업", "제품 개발"] } },
      { id: "education", title: "학력", kind: "items", content: { items: [{ id: "starter-education", meta: "졸업 연도", title: "학교 · 과정", subtitle: "전공", body: "추가 내용" }] } },
      { id: "credentials", title: "자격 · 수상", kind: "items", content: { items: [{ id: "starter-credential", meta: "취득 연도", title: "자격 또는 수상명", subtitle: "발급 · 주관", body: "" }] } },
