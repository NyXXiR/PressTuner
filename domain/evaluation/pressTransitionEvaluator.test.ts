...
test("deterministic evaluator covers topology, metadata privacy and regression gates", () => {
  const dataset = JSON.parse(readFileSync("evals/press-ai-debugger/v2/dataset.json", "utf8")); const baseline = JSON.parse(readFileSync("evals/press-ai-debugger/v2/baseline.json", "utf8"));
