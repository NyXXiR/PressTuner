...
const payloadByKind = {
  ...
  "edge.traversed": z.object({ edgeId: identifier, sourceNodeId: identifier, targetNodeId: identifier, verdict: z.enum(["PASS", "WARN"]), acknowledged: z.boolean(), traversalState: z.enum(["TAKEN", "NOT_TAKEN", "UNKNOWN"]).default("TAKEN"), reasonCode: boundedText(100).nullable().default(null) }).strict(),
