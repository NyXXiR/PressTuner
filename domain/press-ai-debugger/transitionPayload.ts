...
export type PressAttemptInput = Readonly<{ articleId: string; rawText: string; tone: "formal" | "neutral" | "friendly"; reviewInstruction?: string; rewriteInstruction?: string; selectedNoteIds?: readonly string[] }>;
