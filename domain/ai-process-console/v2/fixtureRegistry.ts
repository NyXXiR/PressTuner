...
export const SyntheticFixtureV2Schema = z.strictObject({
  schemaVersion: z.literal("2.0"), fixtureId: z.string().min(1).max(128), processId: z.literal("press-creation"), processVersion: z.enum(["3.0.0", "3.1.0"]),
...
export const syntheticFixturesV2 = Object.freeze([
  ...
  { schemaVersion: "2.0", fixtureId: "success-v2-3-1", processId: "press-creation", processVersion: "3.1.0", scenario: "SUCCESS", memoText: "가상 서비스 엡실론이 2031년 2월 공개된다. 모든 이름과 수치는 합성 데이터다.", tone: "formal", reviewInstruction: "명료성을 확인한다.", rewriteInstruction: "선택한 합성 제안만 반영한다.", selectedNoteIds: ["note_synthetic-session_0"] },
...
const reference = (fixture: SyntheticFixtureV2): ArtifactReferenceV1 => {
  ...
  return { artifactId: `presstuner-fixture-${fixture.fixtureId}`, schemaVersion: "2.0", sha256: sha256Text(content), mediaType: "application/json", sizeBytes: Buffer.byteLength(content), locator: `ref:fixtures/presstuner/press-creation/${fixture.processVersion}/${fixture.fixtureId}` };
};
