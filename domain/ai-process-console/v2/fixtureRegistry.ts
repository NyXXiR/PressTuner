...
export const syntheticFixturesV2 = Object.freeze([
  ...
  { schemaVersion: "2.0", fixtureId: "brief-draft-warn-v2", processId: "press-creation", processVersion: "3.0.0", scenario: "TRANSITION_WARN", memoText: "가상 서비스 베타는 2030년 공개되며 12곳에 제공된다.", normalizedBriefText: "가상 서비스 베타는 2030년 공개된다.", tone: "neutral", reviewInstruction: "브리프의 경고를 확인한다.", rewriteInstruction: "선택한 합성 제안만 반영한다.", selectedNoteIds: ["note_synthetic-session_0"] },
