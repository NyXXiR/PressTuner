...
export const AttemptFailedEventV2Schema = envelope("dev.aiprocess.event.attempt.failed.v2", AttemptMetadataV2Schema, z.strictObject({ failureCode: IdentifierSchema, failedEventId: IdentifierSchema.optional() }));
