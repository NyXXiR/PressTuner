...
export const componentRevisionForNode = (nodeId: string) => {
  ...
  return revision(`presstuner:handler:${node.operationKey}`, PRESS_CREATION_V2_VERSION);
};
export const componentRevisionForTransition = (transitionId: string) => revision(`presstuner:decision:${transitionId}`, PRESS_CREATION_V2_VERSION);
